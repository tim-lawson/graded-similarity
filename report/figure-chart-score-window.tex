...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \end{groupplot}
  \end{tikzpicture}
  \caption{The score against window size for static-embedding models with the additive
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \end{groupplot}
  \end{tikzpicture}
  \caption{The score against window size for contextual-embedding models with the
    additive composition operation.}
\end{figure}
