...
\begin{figure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \caption{Slovene}
  \end{subfigure}
  \caption{The window size that maximises the score for the \texttt{static} model
...
\begin{figure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \caption{Slovene}
  \end{subfigure}
  \caption{The window size that maximises the score for the \texttt{contextual} model
    variants with the additive composition operation.
    The best score for each language is underlined.
  }
...
\begin{figure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    ]{../results/model=pooled_language=en_window=0-10_operation=sum_similarity=cosine_top_1.csv}
    \caption{English}
  \end{subfigure}
  \par\bigskip\par\bigskip
  \begin{subfigure}[b]{\textwidth}
    ...
    ]{../results/model=pooled_language=fi_window=0-10_operation=sum_similarity=cosine_top_1.csv}
    \caption{Finnish}
  \end{subfigure}
  \par\bigskip\par\bigskip
  \begin{subfigure}[b]{\textwidth}
    ...
    ]{../results/model=pooled_language=hr_window=0-10_operation=sum_similarity=cosine_top_1.csv}
    \caption{Croatian}
  \end{subfigure}
  \par\bigskip\par\bigskip
  \begin{subfigure}[b]{\textwidth}
    ...
    ]{../results/model=pooled_language=sl_window=0-10_operation=sum_similarity=cosine_top_1.csv}
    \caption{Slovene}
  \end{subfigure}
  \caption{The window size that maximises the score for the \texttt{pooled} model
    variants with the additive composition operation.
    The best score for each language is underlined.
  }
