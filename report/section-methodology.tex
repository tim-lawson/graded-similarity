...
However, several of the task submissions used a combination of a Transformer's
hidden-states
\parencites[e.g.][276]{Gamallo2020}[61]{CostellaPessutto2020}[145]{Hettiarachchi2020};
hence, I also evaluated an example of this technique.
...
A thorough comparison of variants of this technique is, hwoever, beyond the scope of
this paper.
\begin{samepage}
